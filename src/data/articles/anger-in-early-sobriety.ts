...
export const article: Article = {
  slug: "anger-in-early-sobriety",
  title: "Anger in Early Sobriety: Why You're Furious and What Helps",
  description: "Anger in early sobriety is the numbing wearing off. Here's why rage surfaces in early recovery, how long it lasts, and how to handle it without relapsing.",
  publishedAt: "2026-05-10",
  modifiedAt: "2026-05-10",
  category: "early-recovery",
  quickAnswer: "Anger in early sobriety isn't a personality flaw — it's the numbing agent wearing off. Alcohol and drugs suppressed years of fear, grief, and resentment. Sobriety lets those feelings surface all at once. Expect irritability for weeks to months. Move your body, name what you feel, and never make decisions while activated.",
  faqs: [
    {
      q: "Why am I so angry in early sobriety?",
      a: "Because the substance was doing emotional labor for you. Alcohol and drugs blunt fear, grief, shame, and resentment. When you stop, those feelings come back online — often all at once, often without warning. The anger isn't new. It was already there, just chemically muted for years."
    },
    {
      q: "How long does irritability last when you quit drinking?",
      a: "Acute irritability tends to fade over the first weeks, but post-acute symptoms — including emotional volatility — can linger for months. Timelines vary by substance, dose history, sleep, and stress load. If rage stays disabling past the first few months, that's a signal to involve a clinician, not to white-knuckle harder."
    },
    {
      q: "Can anger trigger a relapse?",
      a: "Yes. Anger and resentment are among the most consistent relapse triggers because they recreate the exact emotional state the substance used to fix. The danger isn't the feeling — it's acting on it while activated. Build a rule: no decisions, no confrontations, no purchases when your nervous system is hot."
    },
    {
      q: "What's the difference between anger and resentment in recovery?",
      a: "Anger is acute — a surge that rises and falls. Resentment is anger that has moved in and unpacked. Acute anger responds to physical discharge and time. Resentment requires deliberate work — usually writing, talking, or therapy — because it's anger married to a story your mind keeps rehearsing."
    },
    {
      q: "When should I get professional help for anger?",
      a: "If you're scaring people you love, breaking things, driving aggressively, or fantasizing about violence — get help now. Call SAMHSA's National Helpline at 1-800-662-4357 for free, confidential treatment referrals. Persistent rage often signals untreated trauma, depression, or a co-occurring condition that recovery alone won't resolve."
    }
  ],
  content: `You are three weeks sober and you just yelled at someone in traffic for a thing that didn't matter. Your hands are shaking. Your jaw hurts from clenching. The smallest interruption — a slow checkout line, a partner asking what's for dinner, a notification — feels like a personal attack.
...
Add the rest of it — disrupted sleep, depleted dopamine, social losses, the [emptiness of evenings](/articles/evening-cravings-sober) that used to be structured around using — and you get a person whose nervous system is stripped of every stabilizer it had learned to rely on.
...
This is why [white-knuckling sobriety](/articles/white-knuckling-sobriety) tends to break down around emotional spikes rather than during quiet stretches. You can grind through boredom. Rage will hijack you.
...
**Sleep.** Almost no one rages well-rested. If you have been sleeping four hours, your anger is partly a sleep symptom, and the intervention is in [the bedroom, not the conversation](/articles/sleep-addiction-recovery).
...
- Spiegelman E. *The Rewired Life: Remarkable Transformations from Negative Thinking to Positive Outcomes*. Hatherleigh Press, 2018.
- Maté G. *In the Realm of Hungry Ghosts: Close Encounters with Addiction*. North Atlantic Books, 2010.
- Substance Abuse and Mental Health Services Administration. National Helpline: 1-800-662-HELP (4357). [SAMHSA.gov](https://www.samhsa.gov/find-help/national-helpline)
- Monument. "Handling Anger in Early Sobriety." joinmonument.com.
...
,
  coverImage: { src: "/articles/anger-in-early-sobriety.webp", alt: "Adult man in driver seat shouting in anger, one hand raised in frustration, other gripping steering wheel." },
};
