...
export const article: Article = {
    ...
    title: "Ego Depletion Is (Mostly) a Myth — And That Changes Everything About Recovery",
    description: "The idea that willpower is a finite tank that empties with use dominated addiction thinking for decades. A massive replication failure says otherwise — and the revised science offers genuine hope.",
