...
export const article: Article = {
    slug: "ego-depletion-myth-recovery",
...
In 2016, a massive replication study involving over two thousand participants across 23 laboratories failed to reproduce the original ego depletion effect. A second multilab failure followed in 2021 (36 labs, over 3,500 participants) — also finding no significant effect. Follow-up meta-analyses found that the published evidence was likely inflated by publication bias — the tendency of journals to publish dramatic positive results and ignore null findings. The foundational experiment, in which participants who resisted cookies subsequently gave up faster on puzzles, may have been capturing something real but far smaller and more situational than originally claimed.
...
Important update: a 2025 multilab study using a more demanding depletion task (30-40 minutes of sustained inhibitory control) did find a significant ego depletion effect. This suggests the phenomenon may be real but requires intense, prolonged self-control demands to emerge — not the brief, mild tasks used in earlier studies. The practical implication for recovery is unchanged: everyday micro-decisions probably don't drain a finite tank, but sustained, high-intensity resistance over hours genuinely does fatigue the system.
...
**You're not doomed to run out of willpower.** The "you'll eventually crack" fatalism that pervades much recovery thinking — and that drives people into [white-knuckling sobriety](/articles/white-knuckling-sobriety) — is not supported by the updated science. Self-control capacity is influenced by beliefs, motivation, and physiological state — all of which you can influence. This doesn't mean recovery is easy. It means the difficulty isn't primarily about a depleting tank.
...
Third, your biological infrastructure is maintained. Sleep, food, movement, connection — and the capacity to [tolerate boredom](/articles/boredom-tolerance-recovery-skill) without reaching for stimulation. These are not rewards for being good. They are prerequisites for being capable.
...
You're not fighting a losing war against your own brain. You are learning to create the conditions under which your brain works for you rather than against you.
