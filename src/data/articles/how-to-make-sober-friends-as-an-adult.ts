...
export const article: Article = {
  slug: "how-to-make-sober-friends-as-an-adult",
  title: "How to Make Sober Friends as an Adult",
  description: "Practical strategies for building real sober friendships in adulthood — what works, what to avoid, and how to push through the awkward early stage.",
  publishedAt: "2026-05-12",
  modifiedAt: "2026-05-12",
  category: "recovery-lifestyle",
  quickAnswer: "Start with one repeated venue — a recovery meeting, a running club, a climbing gym, a volunteer shift — and show up weekly for two months. Friendships form through repeated low-stakes contact, not single events. Tell people early that you don't drink. Accept the awkward stage; it passes once familiar faces become real names.",
  faqs: [
    {
      q: "How do I make friends when everyone my age drinks?",
    ...
    {
      q: "Where can I find sober friends near me?",
      a: "Recovery meetings (AA, SMART Recovery, Refuge Recovery) are the densest concentration of sober people you'll ever encounter. Beyond meetings: sober bars in major cities, run clubs, yoga studios, climbing gyms, dharma groups, and volunteer organizations. The Meetup app and the I Am Sober app both list local sober events."
    },
    {
      q: "Is it normal to feel lonely in early sobriety?",
      a: "Yes — almost universal. You removed not just a substance but the social scaffolding around it: the people, the rituals, the venues. The loneliness is grief, not failure. It usually peaks in the first few months and eases as new connections accumulate. If it deepens into hopelessness, call SAMHSA at 1-800-662-4357."
    },
    {
      q: "How do I tell new people I don't drink?",
      a: "Keep it short and unapologetic. 'I don't drink' is a complete sentence. If pressed, 'It doesn't agree with me' closes most follow-ups. You don't owe anyone your recovery story on first meeting. People mirror your energy — if you treat it as ordinary, they will too."
    },
    {
      q: "Can I keep my old drinking friends?",
      a: "Some, not all. The friends whose connection to you survives without alcohol — usually a small number — stay. The friendships that existed only inside the drinking ritual usually fade, and forcing them tends to threaten your sobriety. Grieve the losses honestly; don't pretend they didn't matter."
    },
    {
      q: "Why is it so hard to socialize without alcohol as an adult?",
      a: "Adult social infrastructure is built around drinking — happy hours, dinners, weddings, networking. Alcohol does the work of lowering inhibition and filling silences. Without it, you have to build social skills that drinking let you skip. The discomfort is a learning curve, not a permanent condition."
    }
  ],
  content: `The first sober friendship I made in recovery started at a folding table in a church basement, drinking bad coffee out of a styrofoam cup, talking to a guy named Mike about his dog. Not about drinking. Not about steps. About his dog.
...
If you want a deeper script for old friends, the article on [how to tell friends you quit drinking](/articles/how-to-tell-friends-i-quit-drinking) covers the longer conversations.
...
Most people I have talked to describe the worst loneliness as concentrated in the first few months, easing through the rest of the first year, and shifting into a different shape later — less acute, more textured. The article on [evening cravings in sobriety](/articles/evening-cravings-sober) covers why nighttime amplifies this.
...
,
  coverImage: { src: "/articles/how-to-make-sober-friends-as-an-adult.webp", alt: "Folding chairs in a circle around a church-basement table with styrofoam coffee cups nearby." },
};
