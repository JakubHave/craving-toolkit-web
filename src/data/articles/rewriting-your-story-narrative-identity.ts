...
export const article: Article = {
    ...
    description: "People trapped in addiction are living in a permanent present — no past examined, no future imaginable. Recovery begins when the loop opens into a line and the story starts moving forward.",
    publishedAt: "2026-04-07",
    content: `There is a moment in Marc Lewis's research that haunts me.
...
This is not just psychology. It has a specific neurological basis.
...
**Reinterpretation of the present.** Once the past is understood, the present can be seen differently. The addiction is no longer a mysterious force — it is a pattern with identifiable roots. The craving is not a sign of permanent brokenness — it is a conditioned response to an unmet need. The struggle is not evidence that you are defective — it is evidence that you are human and that your brain is doing exactly what brains do with intense, repeated experience.

This reinterpretation reduces the power of the addictive identity. Instead of "I am an addict," the narrative becomes "I am a person who developed a destructive coping mechanism in response to specific circumstances, and I am now learning different responses." The shift is subtle in language but seismic in its neurological and psychological effects.
...
You do not need a therapist to begin this work, although therapy can accelerate it. Here is a practical framework.
...
You do not need to share this with anyone. The act of writing it is the intervention. It forces the prefrontal cortex to organize memories, evaluate causes, and construct meaning from raw experience. This is exactly the integrative brain work that addiction disrupted.
...
This is not to excuse the addiction. It is to understand it — because understanding the function tells you what you actually need. And once you know what you need, you can begin to find healthier ways to get it.
...
Each revision is an act of neuroplasticity — the brain updating its self-model, strengthening new connections, weakening old ones. The narrative is not just a story about recovery. It is a mechanism of recovery.
...
You are not just quitting something. You are writing something. The story of who you were, who you are, and who you are becoming. And the writing itself — the act of constructing meaning from chaos, connecting past to future through present action — is what rewires the brain.
