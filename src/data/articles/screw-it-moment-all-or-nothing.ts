...
export const article: Article = {
    ...
    description: "One drink becomes six. One cookie becomes the whole package. The 'screw it' moment turns slips into relapses — and the 10 minutes after a slip are the most important in recovery.",
...
There is no middle ground. No partial credit. No "I slipped but I can course-correct." There is only the binary: either I am maintaining my streak perfectly, or I have failed completely and might as well stop trying.

This cognitive pattern is not unique to addiction. It shows up in dieting (one slice of pizza and the whole diet is "ruined"), in exercise (miss one workout and you "might as well" skip the rest of the week), and in perfectionism of all kinds. But in addiction, the consequences of this thinking pattern are catastrophic — because the difference between a slip and a full relapse is often decided in the "screw it" window.
...
This is the collapse spiral: slip — shame — "I already blew it" — more use — more shame — "might as well keep going" — full relapse. The all-or-nothing framework provides the logical architecture for the spiral. The shame provides the emotional fuel. Together, they turn a single slip into a multi-day catastrophe.

### The slip is not the problem — the interpretation is

Here is the thing that changes everything once you understand it: a slip and a relapse are not the same thing. They are separated by one variable — what you do in the ten minutes after the slip.
...
That transformation is not inevitable. It is a cognitive habit. And cognitive habits can be interrupted.

### How to interrupt the "screw it" moment

**Pre-script the response.** The "screw it" moment arrives when your prefrontal cortex is depleted and your capacity for nuanced thinking is lowest. You cannot rely on in-the-moment reasoning. You need a pre-loaded script — written during a calm moment — that you can deploy automatically when the slip happens.
...
This is not a motivational affirmation. It is an emergency override — a pre-made decision that bypasses the depleted prefrontal cortex and provides a response that the all-or-nothing voice does not want you to have.
...
Try a different metric: percentage days clean. If you have been sober for 89 out of 90 days, you are at 99%. One slip does not make you a failure — it makes you someone who is succeeding 99% of the time. This framing does not excuse the slip, but it prevents the catastrophic interpretation that turns one slip into a full relapse.
...
The 10 minutes after a slip are the most important 10 minutes in recovery. More important than the first day. More important than any milestone. Because those 10 minutes are where the all-or-nothing voice either wins or loses.
...
You cannot prevent every slip. But you can prevent every slip from becoming a relapse. And the tool that does it is not willpower. It is the pre-loaded refusal to accept the all-or-nothing lie that a single mistake means everything is lost.
