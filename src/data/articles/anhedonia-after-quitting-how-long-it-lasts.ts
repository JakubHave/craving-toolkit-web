...
export const article: Article = {
    ...
    content: `You quit. You got through the withdrawal. You are doing everything right. And yet — nothing feels good. Food is tasteless. Music is noise. People are annoying. The things that used to bring you joy, even before the addiction, feel empty. You are not sad exactly. You are not anxious. You just feel... nothing.
...
The point is that anhedonia is not your new reality. It is a phase. A neurochemical phase with a beginning, a predictable middle, and an end. Understanding the timeline — and what is happening in your brain — can be the difference between holding on and giving up.

### What causes anhedonia in recovery

Your brain has a reward system built around dopamine. Under normal conditions, everyday activities — food, conversation, exercise, sunlight, accomplishment — trigger small, healthy releases of dopamine that register as satisfaction or mild pleasure.

When you repeatedly expose your brain to high-dopamine substances or behaviors, it adapts. It reduces the number of dopamine receptors available to receive the signal (downregulation), and it decreases baseline dopamine production. This is the brain's attempt to maintain equilibrium in the face of an artificial flood.
...
Stimulants produce some of the highest dopamine spikes of any drug class — amphetamine increases dopamine release by approximately 1,000% above baseline. The crash is correspondingly severe, and the anhedonia can be profound and long-lasting.
...
Most opioid users report the acute emotional crash lasting 2–4 weeks, with a long tail of low-grade anhedonia extending 6–18 months. Post-acute withdrawal syndrome (PAWS) — which includes mood swings, sleep disruption, and anhedonia — can persist in waves for up to two years in severe cases.
...
The challenge with behavioral addictions is that complete abstinence from the behavior is often harder to maintain because the cues are everywhere. You can avoid a bar, but you cannot avoid a screen. This can extend the recovery timeline if exposure to related stimuli keeps reactivating the reward circuits.
...
The critical thing to know about waves is that they are not relapses and they are not signs of failure. They are a normal feature of neurochemical recovery. Each wave tends to be shorter and less intense than the last, even if it does not feel that way in the moment.

### What helps during the anhedonia phase

**Do not diagnose yourself with depression too quickly.** Many people in early recovery are prescribed antidepressants for what is actually substance-induced anhedonia. While antidepressants may be appropriate in some cases, it is worth giving your brain at least 30 days of abstinence before concluding that you have a standalone mood disorder. The Schuckit and Brown study showed that the majority of depressive symptoms resolved with abstinence alone.

**Track your mood daily.** You will not notice gradual improvement if you are not measuring it. A simple 1–10 rating each morning and evening is enough. After two weeks, look at the trend. Even a small upward slope is meaningful and can keep you going.
...
**Tell someone what you are going through.** Anhedonia is isolating. It makes you want to withdraw, and withdrawal deepens the flatness. Even if you do not feel like socializing, maintaining minimal human connection — a daily check-in text, a weekly meeting — provides neurochemical benefits that you will not feel in the moment but that matter for recovery.
