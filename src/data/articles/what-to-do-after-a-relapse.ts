...
export const article: Article = {
  slug: "what-to-do-after-a-relapse",
  title: "What to Do After a Relapse: The First Hour and Beyond",
  description: "A direct, practical guide to the first hours and days after a relapse: stop the sequence, refuse the shame ritual, and rebuild without starting over.",
  publishedAt: "2026-05-11",
  modifiedAt: "2026-05-11",
  category: "triggers-and-relapse",
  quickAnswer: "Stop the sequence fast. Get away from the substance or setup, eat something, drink water, and tell one trustworthy person within the hour. Skip the self-hatred speech — it usually fuels another round. Then, within a day, review what happened with honesty and reset your plan. If you need medical help or are at risk, call SAMHSA at 1-800-662-4357.",
  faqs: [
    {
      q: "Is one slip the same as a full relapse?",
      a: "Not necessarily. A slip is a single event you interrupt quickly. A relapse is when the slip turns into a return to old patterns — a binge, a weekend, a renewed habit. The difference is almost entirely what you do in the hours after the first use. Stop the sequence fast and a slip stays a slip."
    },
    {
      q: "Should I go back to rehab or treatment?",
      a: "If the relapse involved high-risk substances, withdrawal symptoms, suicidal thoughts, or a pattern you cannot interrupt alone, yes — return to treatment or call SAMHSA at 1-800-662-4357. If it was a single slip you stopped quickly, intensified outpatient support, a sponsor, or therapy may be enough. When in doubt, get a professional opinion the same week."
    },
    {
      q: "How do I tell my sponsor or family I relapsed?",
      a: "Tell them quickly, before shame builds a story. Short, factual, no performance: I used. Here is what happened. Here is what I am doing next. Most people who love you have been bracing for this conversation. Honesty restores the relationship faster than a perfect-looking streak ever did."
    },
    {
    ...
    {
      q: "Do I lose all my progress when I relapse?",
      a: "No. The neural changes built over months of recovery do not disappear in one night. Your tolerance may have dropped, which is a medical risk worth knowing — but the skills, the relationships, the self-knowledge, and the new patterns are still there. You are not starting over. You are continuing from a hard chapter."
    }
  ],
  content: `The relapse already happened. You are reading this with a hangover, a comedown, a half-empty bottle in the kitchen, or the residue of whatever pattern you swore you were done with. Your hands might be shaking. Your phone is full of messages you do not want to read. The streak counter is broken.
...
A relapse is almost never a single moment. It is the visible end of a chain that started days or weeks earlier. Understanding [the three stages of relapse](/articles/three-stages-of-relapse-how-to-catch-yourself) — emotional, mental, and physical — helps you see where the chain actually started. The drink was the last link, not the first.
...
**Pre-load the next craving.** When the next urge hits — and it will, probably tonight — you need a plan that does not require willpower in the moment. The protocol in [how to survive the first 10 minutes of a craving](/articles/survive-first-10-minutes-of-craving) is built for exactly this window.

**Watch for the empty hours.** Boredom and unstructured time are where post-relapse slips breed. If you have not built [boredom tolerance](/articles/boredom-tolerance-recovery-skill) yet, fill the hours with planned activity until you have.
...
- Melemis SM. "Relapse Prevention and the Five Rules of Recovery." *Yale J Biol Med*. 2015;88(3):325-332. [PubMed](https://pubmed.ncbi.nlm.nih.gov/26339218/)
