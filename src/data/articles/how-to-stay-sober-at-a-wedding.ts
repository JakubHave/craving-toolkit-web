...
export const article: Article = {
  slug: "how-to-stay-sober-at-a-wedding",
  title: "How to Stay Sober at a Wedding: A Field Guide",
  description: "Concrete strategies for staying sober at a wedding — pre-event commitments, drink-in-hand tactics, exit plans, and what to do when the toast hits.",
  publishedAt: "2026-05-11",
  modifiedAt: "2026-05-11",
  category: "triggers-and-relapse",
  quickAnswer: "Decide before you arrive that you are not drinking — a maybe almost always becomes a yes. Hold a non-alcoholic drink from the moment you walk in, prepare a one-line refusal, bring or pre-arrange a sober ally, and give yourself permission to leave the second your sobriety feels unsafe.",
  faqs: [
    {
      q: "Should I skip a wedding if I am newly sober?",
      a: "If you are in the first weeks of recovery and the wedding is alcohol-heavy with no sober ally available, skipping is a reasonable choice — not a moral failure. Your sobriety is the foundation everything else rests on. Send a warm note, a gift, and protect the foundation."
    },
    {
      q: "What do I order at the open bar?",
      a: "Walk straight to the bar before anyone offers you anything and order soda water with lime, a tonic with bitters, or a non-alcoholic beer. Holding a glass closes the social loop — most people stop noticing once you already have a drink. Keep it full all night."
    },
    {
      q: "Do I have to tell people why I am not drinking?",
      a: "No. A short line like I am driving, I am on medication, or I am taking a break from alcohol is enough. You owe no one your medical history at a reception. If someone pushes past a polite no twice, that is information about them, not a reason to explain yourself."
    },
    {
      q: "How do I handle the toast?",
      a: "You can toast with anything in a glass — water, sparkling cider, soda. The ritual is in the raised arm and the eye contact, not the liquid. Plan this in advance so the moment does not catch you reaching for a passing champagne flute on autopilot."
    },
    {
      q: "What if a craving hits hard mid-reception?",
      a: "Leave the room. Step into a bathroom, the parking lot, a quiet hallway — anywhere the cue stack thins out. Text your sober ally, call a recovery contact, or dial SAMHSA at 1-800-662-4357. Cravings pass faster than you think when you remove yourself from the stimulus."
    }
  ],
  content: `Weddings are designed to dissolve your defenses. The lights soften. The music swells. Someone you love is crying happy tears at the front of the room. A waiter circles with a tray of champagne flutes that catch the light like they were lit by a cinematographer. Everyone you went to high school with is suddenly four drinks in and hugging you.
...
Each one of those is a trigger. Stacked together, they overwhelm the prefrontal systems you normally rely on. This is the same dynamic that makes [evenings the hardest part of early sobriety](/articles/evening-cravings-sober) — your willpower runs down across the day, and the cue density goes up just as your resistance bottoms out.
...
- **The driving line.** "I am driving tonight." Closes the conversation in five seconds.
- **The health line.** "I am off alcohol right now — feeling better without it." Honest, vague, not your medical record.
- **The boring truth.** "I do not drink anymore." If someone pushes past this, they are revealing something about themselves, not extracting information from you.

You do not owe anyone a recovery story at a wedding reception. [How you talk to friends about quitting](/articles/how-to-tell-friends-i-quit-drinking) can be a longer conversation on a different day.
...
If no one local is available, the [SAMHSA helpline at 1-800-662-4357](https://www.samhsa.gov/find-help/national-helpline) is staffed twenty-four hours a day, free and confidential. Save the number in your phone before you leave for the venue.
...
- **Drink water.** Cold water on the inside of your wrists if you can.
- **Text your ally.** Even just the word "here."
- **Move your body.** Walk the block. Take stairs. Anything to disrupt the freeze.
- **Name what you are actually missing.** Often it is not the alcohol — it is the belonging, the loosening, the permission to feel something. Naming the real need takes pressure off the substitute.
...
If you are traveling for the wedding, the disruption of routine compounds the risk. Your morning structure is gone, your sleep is broken, your people are not there. This is why [the first weeks of sobriety feel so flat](/articles/why-cant-i-feel-pleasure-dopamine-deficit) — and weddings amplify that flatness by surrounding you with manufactured highs you cannot access.
...
- Bee K. "How To Stay Sober At A Wedding (And Still Have Fun)." *The Sober School.* https://thesoberschool.com/how-to-stay-sober-at-a-wedding/
- Huberman A, Humphreys K. Interview on social skills in early recovery. *Huberman Lab Podcast.*
- Huberman A, Soave R. Interview on alcohol and social pressure in recovery. *Huberman Lab Podcast.*
