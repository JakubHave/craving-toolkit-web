...
export const article: Article = {
    ...
    description: "The disease model dominates addiction science. But a growing number of neuroscientists argue the brain changes it cites are not evidence of disease — they are evidence of learning. Here is the third option.",
