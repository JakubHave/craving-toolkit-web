...
export const article: Article = {
    ...
    description: "Is addiction a brain disease, a choice, or something else? Marc Lewis argues it's a learning process — and that changes everything about recovery.",
...
Neither fully captures the science. Addiction is better understood as a deeply learned habit — not a disease (the brain changes are normal learning, not pathology) and not a free choice (the neurological entrenchment makes stopping feel impossible). Neuroscientist Marc Lewis calls it a developmental process.

**Why do some scientists say addiction is not a disease?**
Because the brain changes cited by the disease model — dopamine receptor downregulation, weakened prefrontal connections — are the same types of changes produced by any intensely repeated experience. They are evidence of neuroplasticity (learning), not pathology. No biomarker distinguishes "addicted" brains from brains that have deeply learned any other intense habit.

**If addiction is not a disease, can addicts just stop?**
No. The learning model does not imply that stopping is easy or voluntary. Deeply entrenched neural pathways resist change. But unlike a disease, they can be overwritten through new learning, new experiences, and identity shifts — which is exactly what recovery involves.
