...
export const article: Article = {
    ...
    title: "Is Addiction a Disease or a Learning Process?",
    description:
      "Is addiction a brain disease, a choice, or something else? Marc Lewis argues it's a learning process — and that changes everything about recovery.",
    publishedAt: "2025-10-22",
    modifiedAt: "2026-05-03",
    category: "understanding-addiction",
    quickAnswer:
      "Addiction is best understood as deeply entrenched learning, not a disease and not a free choice. The brain changes that disease-model proponents cite — dopamine downregulation, weakened prefrontal connections — are the same kind of changes produced by any intensely repeated experience. They are evidence of neuroplasticity, not pathology. The brain that learned its way in can learn its way out.",
    faqs: [
      {
        q: "Is addiction a disease or a choice?",
        a: "Neither fully captures the science. Addiction is better understood as a deeply learned habit — not a disease (the brain changes are normal learning, not pathology) and not a free choice (the neurological entrenchment makes stopping feel impossible). Neuroscientist Marc Lewis calls it a developmental process.",
      },
      {
        q: "Why do some scientists say addiction is not a disease?",
        a: "Because the brain changes cited by the disease model — dopamine receptor downregulation, weakened prefrontal connections — are the same types of changes produced by any intensely repeated experience. They are evidence of neuroplasticity (learning), not pathology. No biomarker distinguishes \"addicted\" brains from brains that have deeply learned any other intense habit.",
      },
      {
        q: "If addiction is not a disease, can addicts just stop?",
        a: "No. The learning model does not imply that stopping is easy or voluntary. Deeply entrenched neural pathways resist change. But unlike a disease, they can be overwritten through new learning, new experiences, and identity shifts — which is exactly what recovery involves.",
      },
    ],
...
Neuroscientist [Marc Lewis](https://memoirsofanaddictedbrain.com/) spent years addicted to opioids and stimulants before becoming a professor who studies the brain. His conclusion, after examining the same brain scans and research papers that the disease model cites, is provocative: addiction is not a disease. It is a learning process — the deepest, most intense form of habit formation the brain is capable of.

This isn't the same as calling addiction a "choice." It is a third option that the disease-versus-choice debate almost always misses.
...
These aren't small contributions. But there's a problem.
...
The learning model doesn't deny that addiction is destructive. It doesn't minimize the suffering. And it absolutely does not claim that addicts can "just stop." What it claims is that the mechanism driving addiction is the same mechanism driving all deep learning — and that understanding this correctly changes how we approach recovery.

Here's how Lewis describes the process:

The brain is designed to pursue rewards. When it encounters something highly rewarding — a drug, a behavior, a relationship — dopamine surges in the striatum, flagging the experience as important and tipping the [pleasure-pain balance](/articles/pleasure-pain-balance-explains-addiction). Attention narrows onto this reward. The brain begins building neural pathways to make the pursuit more efficient: cue recognition becomes automatic, anticipation strengthens, competing interests fade.
...
This is what Lewis calls the "[narrowing tunnel of desire](/articles/narrowing-effect-addiction)." The world of pleasurable possibilities progressively shrinks until only one reward remains compelling. Not because the brain is broken, but because it has learned too well and too narrowly.
...
**It removes the "forever" sentence.** The disease model tells people they will always be addicts — "[once an addict, always an addict](/articles/once-an-addict-always-an-addict)," in recovery for life, permanently vulnerable, one slip away from relapse at any moment. The learning model says something different: the neural pathways of addiction weaken with disuse and are progressively replaced by new ones. You are not managing a chronic condition. You are growing into a different person. The old pathways do not fully disappear (sensitization persists), but they lose their dominance as new learning takes hold.
...
Lewis offers a third path: addiction as development. A destructive phase in the ongoing development of personality, shaped by the same forces that shape all human growth — desire, learning, habit formation, and the brain's relentless pursuit of reward. It isn't chosen in any simple sense. But it's also not a malfunction. It is the dark side of a brain doing exactly what it was designed to do.
...
- Lewis M. "Addiction and the Brain: Development, Not Disease." *Neuroethics*. 2017;10(1):7-18. [PubMed](https://pubmed.ncbi.nlm.nih.gov/28725282/)
...
- Maguire EA, et al. "Navigation-related structural change in the hippocampi of taxi drivers." *Proc Natl Acad Sci USA*. 2000;97(8):4398-4403.
