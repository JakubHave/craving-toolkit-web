...
export const article: Article = {
  slug: "hangxiety",
  title: "Hangxiety: Why You Feel Anxious the Day After Drinking",
  description: "Hangxiety is post-drinking anxiety caused by a GABA-glutamate rebound. What it is, why it happens, and what actually helps in the next few hours.",
  publishedAt: "2026-05-11",
  modifiedAt: "2026-05-11",
  category: "understanding-addiction",
  quickAnswer: "Hangxiety is the anxiety, dread, and emotional fragility you feel the day after drinking. It happens because alcohol artificially boosts GABA and suppresses glutamate; as it clears, your brain rebounds in the opposite direction — overstimulated, hypervigilant, and primed for threat. The state is chemical and time-limited. It will pass.",
  faqs: [
    {
      q: "How long does hangxiety last?",
      a: "Most people feel hangxiety lift within roughly a day, though heavy sessions can stretch it longer. The intensity tends to peak in the morning and gradually fade as your nervous system rebalances. Eating, hydrating, moving gently, and avoiding more alcohol or excessive caffeine will shorten the curve."
    },
    {
      q: "Why do I get hangxiety after only a few drinks?",
      a: "Sensitivity varies. People with existing anxiety, poor sleep, low body weight, or a hot baseline nervous system tend to feel the rebound disproportionately, even after moderate drinking. Genetics, medications, and how recently you last drank all factor in. The amount that triggers hangxiety is not a measure of toughness."
    },
    {
      q: "Can hangxiety be a sign of an alcohol problem?",
      a: "Repeated hangxiety after drinking is a meaningful signal. It does not automatically mean alcohol use disorder, but the loop it creates — drinking to relieve anxiety, then waking up more anxious — is one of the cleanest pathways into dependence. If the pattern is recurring, take it seriously."
    },
    {
      q: "Will hangxiety go away if I quit drinking?",
      a: "Yes — the acute episodes stop entirely. The deeper recalibration takes longer; your nervous system may run hot for weeks as it returns to baseline. Most people report that their general anxiety level drops below where it was during drinking days, often within a few months of consistent sobriety."
    },
    {
      q: "Is hair of the dog a safe way to stop hangxiety?",
      a: "No. Drinking again briefly delays the rebound by re-suppressing your nervous system, but the underlying neurochemical debt grows. You are borrowing from tomorrow at a higher rate. For frequent drinkers, hair-of-the-dog is one of the most reliable accelerators of dependence. If you cannot get through the morning without it, seek help."
    }
  ],
  content: `You wake at 4 AM with your heart pounding. The sheets feel wrong. Your phone is face down on the nightstand and you cannot bring yourself to check it. Something is wrong, but you cannot remember what. Then you do remember: you drank last night.
...
**Use a calming practice you already know.** This is not the time to learn meditation. But if you have a breath practice, a body scan, or a [meditation routine you've already built](/articles/meditation-addiction-recovery-curiosity), use it. The point is not to feel good. The point is to remind your nervous system that you are not, in fact, under attack.
...
The relief on the other side of quitting is not just the absence of hangxiety. It is the slow return of a stable mood floor — the thing alcohol borrowed against and then defaulted on. You may have to walk through a stretch of [boredom and flatness](/articles/why-sobriety-feels-boring-dopamine-science) as your dopamine system recalibrates, and learning to [sit with empty time](/articles/boredom-tolerance-recovery-skill) is its own skill. But the dread mornings stop. The phone stops being terrifying. The morning is yours again.
...
- Alcohol and Drug Foundation. "What is hangxiety?" adf.org.au.
- Cleveland Clinic. "Hangxiety: Why You Feel So Anxious the Day After Drinking." health.clevelandclinic.org.
