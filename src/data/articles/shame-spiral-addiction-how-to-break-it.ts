...
**Expect the shame wave after a slip.** If you relapse, the shame will come hard and fast. [The addictive voice](/articles/the-addictive-voice-how-your-mind-talks-you-into-relapse) will use it: "You already blew it. You are pathetic. Might as well keep going." That's the [screw-it moment](/articles/screw-it-moment-all-or-nothing) — and it is the most dangerous moment in the spiral. If you can catch yourself here — even for one minute — and reach for a phone instead of the substance, you can interrupt the cycle.
