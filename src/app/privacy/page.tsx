...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      "If you buy the ebook, checkout, payment processing, taxes, and digital delivery are handled by Gumroad or another third-party checkout provider displayed at the time of purchase.",
