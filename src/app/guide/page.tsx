...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: "https://www.cravingtoolkit.com/guide",
    images: [
      {
        url: "/cover.jpg",
        width: 1200,
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-200">
        ...
        <div className="relative max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          <div className="animate-fade-in-up-delay-2 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#pricing" className="group bg-emerald-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/25 hover:shadow-xl hover:shadow-emerald-600/30 hover:-translate-y-0.5 flex items-center gap-2">
              Buy the guide <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-0.5" />
            </a>
            <Link
              href="/preview"
              className="group inline-flex items-center gap-2 px-6 py-4 rounded-full border-2 border-emerald-600 text-emerald-700 font-semibold hover:bg-emerald-50 transition-all text-base"
            >
              Read free preview
            </Link>
          </div>
      ...
      <section className="py-20 bg-white border-y border-slate-100">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4 leading-snug">There&rsquo;s also an app.</h2>
          <p className="text-lg text-slate-500 mb-8 leading-relaxed max-w-2xl mx-auto">
            The Craving Toolkit app puts these tools in your pocket — emergency timer, urge surfing, voice of truth, craving log. Free, fully offline, no account.
          </p>
